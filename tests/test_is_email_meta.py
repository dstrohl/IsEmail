...
TEST_DATA_RULES = dict(
    start=_char('abcdef'),
    alpha=_c(_char('abcdefghijklmnopqrstuvwxyz')),
    ...
    c_rule_min_max=_c('2*3', _char('abcd')),
    c_rule_unl=_c('*', _char('abcd')),
    c_rule_unl2=_c(_char('abcd')),
    m_rule=_m(_char('abcd')),
    m_rule_pass_fail=_m('start', on_fail=20, on_pass=10),
    m_rule_element_name=_m(_or('alpha', _c('SPACE')), element_name='test_name', on_fail=20, on_pass=10),
    ...
    quoted_char_str2=_and(_c(3, _char('foo')), 'COMMA', '"bar"'),

    complex_and=_and(_c('*5', 'LTR_STR'), _opt(_and('DOT', _c('*5', 'LTR_STR')))),

    complex_or=_or(_c('5', _char('abcde')), _c('1', _char('fghijk'))),
    complex_and_or=_or(
        _and(
            _c('*5', 'ALPHA'),
            _opt(_and('DOT', _c('ALPHA')))),
        _and(
            'HEXDIG',
            _opt(_and('"::"', 'HEXDIG')))),
    complex_and_or2=_or(
        _and(
            _c('*5', 'ALPHA'),
            _c(_opt(_and('DOT', _c(2, 'ALPHA'))))),
        _and(
            _c(5, 'HEXDIG'),
            _c('*3', _opt(_and('"::"', _c(5, ('HEXDIG'))))))),
    multiple_marks_rule=_and(
        _m(_c('[LTR_STR]'), element_name='pre', on_pass=11, on_fail=101),
        _m(_and(
        ...
        _m(_c('[LTR_STR]'), element_name='post', on_pass=15, on_fail=105))
